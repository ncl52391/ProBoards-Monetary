...
monetary.shop = (function(){
	...
	return {
		...
		/**
		 * Bridges Yootil 1.x helper names/signatures used by the shop to newer Yootil builds.
		 */

		ensure_yootil_compatibility: function(){
		...
		init: function(){
			...
			this.ensure_yootil_compatibility();
